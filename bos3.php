				...
				<div class="block">
					<div class="container">
						<ul class="breadcrumbs">
							...
							<li>/<span>Booster 3 Team</span></li>
						</ul>
					</div>
				</div>
				<div class="container">
                                                    ...
                                                    <div class="row form-row">
                                                        <div class="col-12 col-lg-9">
                                                            ...
                                                            <?php
                                                                ...
                                                                FROM `child_counter_3` t1 where t1.uid LIKE '$customeid%' ");
                                                    ...
                                                    <div class="card dashboard-table mt-0">
                                                        <div class="card-body table-responsive-sm" style="padding:0;">
                                                            ...
                                                            <?php
                                                                ...
                                                                if($icd != '0'){
                                                                    $brnadSQL="select t1.* from child_counter_3 t1 where t1.uid = '$icd'"; 

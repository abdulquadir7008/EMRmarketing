...
<main class="page-main">
				<div class="block">
					<div class="container">
						<ul class="breadcrumbs">
							...
							<li>/<span>Sponser Register</span></li>
						</ul>
					</div>
				</div>
				<div class="block">
        ...
        ?>
            ...
            <div class="row form-row">
				<div class="col-md-4">
                <label class="field-label">Sponser Id *</label>
                <input type="text" name="spneser_id" maxlength="30" class="form-control" placeholder="sponser_id" required>
              </div>
              ...
              <div class="col-md-4">
                ...
                <input type="text" name="state" maxlength="50" class="form-control" placeholder="State" required>
              </div>
				<div class="col-md-4">
              ...
              <div class="col-md-6">
                <input type="hidden" name="country" class="form-control" placeholder="Street address">
              </div>
            </div>
            <div class="middle">
              <label>
              <input type="radio" name="gender" value="female" checked/>
        <span class="fa fa-female"><strong>Women</strong></span> 
              </label>
              <label>
              <input type="radio" name="gender" value="male" />
              <span class="fa fa-male"><strong>Men</strong></span>
              </label>
            </div>

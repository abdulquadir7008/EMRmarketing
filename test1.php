...
require 'vendor_email/autoload.php';
	...
	$lname='test';
	$phone='1234567890';
	$email='fucssummoffuddeixa-7646@yopmail.com';
	$country='test';
	$stree_address='test';
	$city='test';
	$state='test';
	...
	// if(isset('85')){
		...
		$SqlSponsergen = mysqli_query($link,"select * from membership where userid='emr0085'"); 
	...
	if($email!='')
	{	
        // echo "select * from membership where email='fucssummouddeixa-7646@yopmail.com' and status ='2'";
		$result=mysqli_query($link,"select * from membership where email='fucssummouddeixa-7646@yopmail.com' and status ='2'");

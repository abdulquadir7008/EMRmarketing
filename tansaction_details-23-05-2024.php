...
$logs_sql="select * from datalogs WHERE merchant_reference='$order_id'";
...
<td valign='top' style='border-right: 1px solid #ddd; border-bottom: 1px solid #ddd; padding: 10px'><h5 style='font-size: 14px; color:#444;margin-top:15px'><b>".$row_order['price']."</b></h5></td></tr>";
						...
						<div class="total-sec">
                            <ul>
                                ...
                                <li>subtotal <span><?php  $subtotal= $order_sub_total;?><?php echo $order_sub_total ;?></span></li>
								...
								<?php $ad_icncome_sql = mysqli_query( $link, "select * from ad_view_wallet WHERE user_id='$custID'" );
                                    ...
                                    <li><?php echo $listlg['reason_discount'];?> : <span><?php echo $discountAmount;?></span></li>
                                                            <?php //$ad_icncome_sql = mysqli_query( $link, "select * from ad_view_wallet WHERE user_id='$custID'" );
                                        // $list_income = mysqli_fetch_array( $ad_icncome_sql );
                                            // $walletamount = $list_income['wallet'];
                                                                        ...
                                                                        <span class="count">  <?php echo $tax=number_format($subtotal * 18 / 100,2, '.', ',') ?><span class='mibaed'>INR</span>
                        ...
                        <div class="final-total">
                            <h3>total <span>
                            <?php echo number_format(($subtotal + $tax),2, '.', ',' );
                                         ?>

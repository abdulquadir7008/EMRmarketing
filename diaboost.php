...
{
    $id = $_GET['level'];
    $res=GetUsersIDPool($db,$id,$customeid,'pairing_3'); 
}
?>
<!DOCTYPE html>
<html lang="en">
				...
				<div class="block">
					<div class="container">
						<ul class="breadcrumbs">
							...
							<li>/<span>Diamond Booster Team</span></li>
						</ul>
					</div>
				</div>
				<div class="container">
                                                ...
                                                <form name="LevelFilter" action="" method="get" class="row row-cols-lg-auto align-items-center">
                                                    <div class="row form-row">
                                                        <div class="col-12 col-lg-9">
                                                            <label class="field-label">Select Level</label>

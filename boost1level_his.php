				...
				<div class="block">
					<div class="container">
						<ul class="breadcrumbs">
							...
							<li>/<span>Booster 1 Level Income</span></li>
						</ul>
					</div>
				</div>
				<div class="container">
                                    ...
                                    <div class="card dashboard-table mt-0">
                                        <div class="card-body table-responsive-sm" style="padding:0;">
											...
											?>
                                             <?php
                                                $i = 1;
                                                 $brnadSQL="select t1.* from boost1_level_income t1 where  t1.amount > 0 and t1.fuid='$customeid' order by t1.id DESC"; 

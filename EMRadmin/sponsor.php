        ...
        <div class="row">
          <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
              <h4 class="mb-0">Sponsor Amount</h4>
              <div class="page-title-right">
                <ol class="breadcrumb m-0">
                  <li class="breadcrumb-item"><a href="javascript: void(0);">EMR</a></li>
                  <li class="breadcrumb-item active">Sponsor Amount</li>
                </ol>
              </div>
            </div>
          </div>
            ...
            <div class="tab-content p-3 text-muted">
                <div class="tab-pane active" id="general-elements" role="tabpanel">
                    <form action="script/setting_script.php" method="post" enctype="multipart/form-data" name="cont"  id="register" onSubmit="return validate();">
                        <div class="row">
                            <h4 class="card-title">Set Sponsor Amount</h4>
                            <div class="col-md-6">
                                <label>For 2000 Plan</label>
                                <input type="number" class="form-control" name="percent" placeholder="Enter...Amount" value="<?php echo $profile_row['percent']; ?>" />
                            </div> 
                            <div class="col-md-6">
                                <label>For 3000 Plan</label>
                                <input type="number" class="form-control" name="percent2" placeholder="Enter...Amount" value="<?php echo $profile_row['percent2']; ?>" />
                            </div> 
                        </div><br>
                        <div class="mb-3">
                            <button type="submit" name="percentsetting" class="btn btn-primary">Save</button>
                        </div>
                    </form>
                </div>
            </div>

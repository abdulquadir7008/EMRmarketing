...
<head>
<meta charset="utf-8" />
<title>Wallet | EMR Marketing</title>
        ...
        <div class="row">
          <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
              <h4 class="mb-0">Total Withdraw to Main Wallet</h4>
              <div class="page-title-right">
                <ol class="breadcrumb m-0">
                  <li class="breadcrumb-item"><a href="javascript: void(0);">Wallet</a></li>
                  <li class="breadcrumb-item active">Total Withdraw to Main Wallet</li>
                </ol>
              </div>
            </div>
          </div>
...
ORDER BY 
    MAX(ma.id) DESC;";
                  ...
                  <tr>
                    ...
                    <td><?php echo $Listlog['userId'];?></td>
                    <td><?php echo $Listlog['fname']." ".$Listlog['lname'];?></td>
                    <td><?php $timestamp = strtotime($Listlog['wlDate']); echo date('d/m/Y H:i:a', $timestamp); ?></td>
                    <td><?php echo $Listlog['total_amount'];?></td>
                  </tr>
                  <?php } ?>
                </tbody>
              </table>

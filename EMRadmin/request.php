...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Fund Request | EMR Marketing</title>
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="table-responsive mb-4">
                                    <table class="table table-centered datatable dt-responsive nowrap table-card-list" style="border-collapse: collapse; border-spacing: 0 12px; width: 100%;">
                                        ...
                                        <?php
                                        $i = 1;
                                        $brnadSQL="select t1.*,t1.status as st,t1.date as sdat,t2.* from up_trans_history1 t1 join membership t2 on t2.member_id = t1.uid where t1.status = 0 order by t1.id DESC"; 
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php 
                                                    if($Listbrand['st']=='0'){ ?>
                                                        <span class="badge btn btn-primary badge-success ApproveRejTopup" data-id="<?php echo $Listbrand['id'];?>" data-status="1">Approve</span>
                                                        <span class="badge btn btn-primary badge-danger ApproveRejTopup" data-id="<?php echo $Listbrand['id'];?>" data-status="2">Reject</span>
                                                    <?php }
                                                    else{echo "Approved";}
                                                ?>
                                            </td>
                                            ...
                                            <td><a target="_blank" href="../uploads/<?php echo $Listbrand['txn_sc'];?>"> <img src="../uploads/<?php echo $Listbrand['txn_sc'];?>" width="100" height="100" class="alignLeft" /> </a></td>
                                            <td><?php if($Listbrand['wal_type']=='2'){ echo "Pool 2 Wallet";}elseif($Listbrand['wal_type']=='6'){ echo "Booster 1 Wallet";}elseif($Listbrand['wal_type']=='7'){ echo "Gold Booster Wallet";}elseif($Listbrand['wal_type']=='8'){ echo "Diamond Booster Wallet";}elseif($Listbrand['wal_type']=='9'){ echo "Robotic Wallet";}?></td>
...
<?php include('includes/footer.php')?>
        ...
        <script>
            $("body").on('click', '.ApproveRejTopup', function()
            {
                $elm=$(this);
                bootbox.confirm({

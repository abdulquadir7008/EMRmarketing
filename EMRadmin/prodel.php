...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Product Delivery | EMR Marketing</title>
  ...
  <div id="layout-wrapper">
                            ...
                            <?php
                                ...
                                <div class="col-lg-12">
                                    <div class="table-responsive mb-4">
                                        ...
                                        <table id="example" class="  table-bordered table-hover  display nowrap" style="width:100%">
                                            <thead>
                                            ...
                                            <?php
                                                $i = 1;
                                                $brnadSQL="SELECT *,product_status as stt FROM `membership`  WHERE `member_id` != '85' AND (`binary_status` = '1' OR `binary_status` = '2') "; 
                                                $ResultSQL=mysqli_query($link,$brnadSQL); 
                                                while($Listbrand=mysqli_fetch_array($ResultSQL)) { 
                                                    $auio = mysqli_fetch_assoc(mysqli_query($db,"SELECT *,DATE(`date`) as dt FROM `pool_activation` WHERE `uid`='$Listbrand[member_id]' and `pool` = 1 ORDER BY `date` ASC limit 1"));
                                                    $act_date = $auio['dt'];
                                            ?>
                                            <tr>
                                                <td><?php echo $i++;?> </td>
                                                ...
                                                <td><?php   
                                                        if($Listbrand['binary_status']=='1'){ echo "2000 Plan";}
                                                        else{echo "3000 Plan";}
                                                    ?>
                                                </td>
                                                <td><?php echo $act_date;?></td>
                                                <td><?php echo $Listbrand['deliver_date'];?></td>
                                                <td>
                                                    <?php   
                                                        if($Listbrand['stt']=='0'){ ?>
                                                            <span class="badge btn btn-primary badge-danger ApproveProduct" data-id="<?php echo $Listbrand['member_id'];?>" data-status="1">Deliver Product</span>
                                                        <?php }
                                                        else{echo "Delivered";}
                                                    ?>
                                                </td>
        ...
        <script>
            $("body").on('click', '.ApproveProduct', function()
            {
                $elm=$(this);
                bootbox.confirm({
                    message: "Warning: You are about to Deliver. Continue to Deliver?",
                    buttons: {
                        confirm: {
                            label: 'Yes',

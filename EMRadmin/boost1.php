...
{
    $id = $_GET['level'];
    $res=GetUsersIDPool($db,$id,'85','pairing_4'); 
}
?>
<!doctype html>
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Booster 1 Team | EMR Marketing</title>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0">Booster 1 Team </h4>

                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="javascript: void(0);">CMS</a></li>
                                            <li class="breadcrumb-item active">Booster 1 Team </li>
                                        </ol>
                                    </div>
                                ...
                                <div class="table-responsive mb-4">
                                    ...
                                    <table class="table table-centered datatable dt-responsive nowrap table-card-list" style="border-collapse: collapse; border-spacing: 0 12px; width: 100%;">
                                        ...
                                        <?php
                                            ...
                                            { 
                                                // echo $val;
                                                $brnadSQL="select t1.*,t2.* from `pairing_4` t1 join membership t2 on t2.member_id = t1.uid WHERE t1.uid = '$val' "; 

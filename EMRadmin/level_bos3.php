...
{
    $isd = $_GET['level'];
    $res=GetUsersIDPool($db,$id,'85.1','pairing_3'); 
    // $res=GetUsersIDPool($db,$ci,$icd,'pairing_3'); 
    // print_r($res);die;
}
else {
    $isd = 1;
    $res=GetUidsSelfPool($db,'85.1','pairing_3');
...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Level Wise Booster 3 Team | EMR Marketing</title>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0">Level Wise Booster 3 Team </h4>

                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="javascript: void(0);">CMS</a></li>
                                            <li class="breadcrumb-item active">Level Wise Booster 3 Team </li>
                                        </ol>
                                    </div>
                                ...
                                <div class="table-responsive mb-4">
                                    ...
                                    <table class="table table-centered datatable dt-responsive nowrap table-card-list" style="border-collapse: collapse; border-spacing: 0 12px; width: 100%;">
                                        ...
                                        { 
                                            ...
                                            $Listbrand=mysqli_fetch_assoc(mysqli_query($db,"select t1.* from `child_counter_3` t1  WHERE `uid` = '$val'"));
                                        ?>

...
<div id="layout-wrapper">
  ...
  <div class="customer_records">
     <div class="mb-3">
                          ...
                          <div class="col-md-12">
							  <h4>Product Choose color Gallery</h4>
                            <div class="mb-3 row">
...
<a class="extra-fields-customer" href="#">Add More Customer</a>
                    ...
                    <div class="row mb-4">
                      <div class="col text-end"> <a href="product-verient-manage-MW.php" class="btn btn-danger"> <i class="fa fa-times me-1"></i> Cancel </a>

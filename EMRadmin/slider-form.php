...
<head>
<meta charset="utf-8" />
<title>Add Banner | EMR Marketing</title>
  ...
  <div class="main-content">
    <div class="page-content">
      <div class="container-fluid"> 
        ...
        <form action="slider-manage.php" name="cont" class="dropzone" id="myform"  method="post" enctype="multipart/form-data">
          <div class="row">
            <div class="col-lg-12">
                  ...
                  <div id="addproduct-billinginfo-collapse" class="collapse show" data-bs-parent="#addproduct-accordion">
                    <div class="p-4 border-top">
                      ...
                      <div class="row">
                        <div class="col-lg-4">
                          <div class="mb-3">
                            <label class="form-label" for="manufacturerbrand">Main Category</label>
                            <select class="form-control select2" name="category" onChange="showCity(this);">
                              <option>Select</option>
                              <option value="women" <?php if($row_cms['category']=='women'){?>selected<?php } ?>>Women</option>
                              <option value="men" <?php if($row_cms['category']=='men'){?>selected<?php } ?>>men</option>
                              <option value="kids" <?php if($row_cms['category']=='kids'){?>selected<?php } ?>>Kid</option>
                            </select>
                          </div>
                        </div>
                        <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                          <div class="mb-3">
                            <label class="form-label" for="price">Heading</label>
                            <input id="sortorder" name="heading" type="text" class="form-control" value="<?php echo $row_cms['heading'];?>">
                          </div>
                        </div>
                      </div>
                      <div class="row">
                        ...
                        <div class="col-md-4">
                          <div class="mb-3">
                            <label class="form-label" for="price">Button Name</label>
                            <input id="linname" name="linname" type="text" class="form-control" value="<?php echo $row_cms['linname'];?>">
                          </div>
                        </div>
                        <div class="col-md-4">
                          <div class="mb-3">
                            <label class="form-label" for="price">Button link</label>
                            <input id="linkgo" name="linkgo" type="text" class="form-control" value="<?php echo $row_cms['linkgo'];?>">
                          </div>
                        </div>
                        <div class="mb-4 row">
                                            <label for="example-color-input" class="col-md-2 col-form-label">Color picker</label>
                                            <div class="col-md-10">
                                          <input type="color" name="colorpick" class="form-control form-control-color" id="exampleColorInput" value="<?php echo $row_cms['colorpick']; ?>" title="Choose your color">
                                            </div>
                                        </div>
                        <div class="box-fileupload col-md-3">
                          ...
                          <img src="../uploads/slider/<?php echo $row_cms['image2'];?>" width="<?php echo $width; ?>100" height="<?php echo $height; ?>" class="alignLeft" />
                          <?php } ?>
                        </div>
                      </div>
                      <div class="mb-0">
                        <label class="form-label" for="productdesc">Product Description</label>
                        <textarea class="form-control" name="content" id="classic-editor" rows="4"><?php echo $row_cms['content'];?></textarea>
                      </div>
                    </div>
                  </div>
                </div>

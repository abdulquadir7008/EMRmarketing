...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>KYC Approved | EMR Marketing</title>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0">KYC Approved </h4>

                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="javascript: void(0);">CMS</a></li>
                                            <li class="breadcrumb-item active">KYC Approved </li>
                                        </ol>
                                    </div>
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="table-responsive mb-4">
                                    <table class="table table-centered datatable dt-responsive nowrap table-card-list" style="border-collapse: collapse; border-spacing: 0 12px; width: 100%;">
                                        ...
                                        <?php
                                        $i = 1;
                                        $brnadSQL="select t1.*,t1.status as st,t1.mdate as sdat,t2.* from up_trans_history11 t1 join membership t2 on t2.member_id = t1.uid where t1.status = 1 order by t1.id DESC"; 
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php 
                                                    if($Listbrand['st']=='1'){ ?>
                                                        <span class="badge btn btn-primary badge-danger DeleteKYC" data-id="<?php echo $Listbrand['id'];?>" data-status="1">Delete KYC</span>
                                                    <?php }
                                                    else{echo "Approved";}
                                                ?>
                                            </td>
...
<?php include('includes/footer.php')?>
        ...
        <script>
            $("body").on('click', '.DeleteKYC', function()
            {
                $elm=$(this);
                bootbox.confirm({
                    message: "Warning: You are about to Delete KYC. Continue to Delete KYC?",
                    buttons: {
                        confirm: {
                            label: 'Yes',

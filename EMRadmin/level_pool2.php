...
{
    $isd = $_GET['level'];
    $res=GetUsersIDPool($db,$id,'85.1','pairing_1'); 
    // $res=GetUsersIDPool($db,$ci,$icd,'pairing_1'); 
    // print_r($res);die;
}
else {
    $isd = 1;
    $res=GetUidsSelfPool($db,'85.1','pairing_1');
...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Level Wise Pool 2 Team | EMR Marketing</title>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0">Level Wise Pool 2 Team </h4>

                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="javascript: void(0);">CMS</a></li>
                                            <li class="breadcrumb-item active">Level Wise Pool 2 Team </li>
                                        </ol>
                                    </div>
                                ...
                                <div class="table-responsive mb-4">
                                    ...
                                    <table class="table table-centered datatable dt-responsive nowrap table-card-list" style="border-collapse: collapse; border-spacing: 0 12px; width: 100%;">
                                        ...
                                        <tr>
                                            ...
                                            <td><?php if($id == 1){echo $amt = "50";}elseif($id == 2){echo $amt = "100";}elseif($id == 3){echo $amt = "200";}elseif($id == 4){echo $amt = "400";}elseif($id == 5){echo $amt = "800";}elseif($id == 6){echo $amt = "525";}elseif($id == 7){echo $amt = "375";}elseif($id == 8){echo $amt = "750";}elseif($id == 9){echo $amt = "1500";}elseif($id == 10){echo $amt = "2325";}elseif($id == 11){echo $amt = "3675";}?> </td>
...
<?php
...

    {
...

        {
            ...
            $res=getSelfLevelPool11($db,$res1,$type);
    ...
    function getSelfLevelPool11($db,$res_arr,$type)

    {

        $res3=array();

        $res1=getSelfLevelPool10($db,$res_arr,$type);

...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Left Team | EMR Marketing</title>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0">Left Team </h4>

                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="javascript: void(0);">CMS</a></li>
                                            <li class="breadcrumb-item active">Left Team </li>
                                        </ol>
                                    </div>
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="table-responsive mb-4">
                                    <table class="table table-centered datatable dt-responsive nowrap table-card-list" style="border-collapse: collapse; border-spacing: 0 12px; width: 100%;">
                                        ...
                                        <?php
				   $i = 1;
                   $res1=GetUserByPos($db,85,'L');
                   if(count($res1) > 0)
                    {
                        $res2=implode(',',$res1);
                        $brnadSQL="SELECT t3.position,t1.member_id as ttid,t1.* from membership t1 left join pairing t3 on t1.member_id=t3.uid where t1.member_id in ($res2) order by t1.member_id desc";
                    }
// $brnadSQL="select t1.*,t2.* from pairing t1 join membership t2 on t2.member_id = t1.uid WHERE t1.position = 'L' "; 
...
<tr>
    ...
    <td><?php echo $Listbrand['position'];?> </td>

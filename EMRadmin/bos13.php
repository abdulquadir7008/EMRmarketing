...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Booster 1 (B3) Team  | EMR Marketing</title>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0">Booster 1 (B3) Team  </h4>

                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="javascript: void(0);">CMS</a></li>
                                            <li class="breadcrumb-item active">Booster 1 (B3) Team  </li>
                                        </ol>
                                    </div>
                                ...
                                <div class="table-responsive mb-4">
                                        ...
                                        <form name="LevelFilter" action="" method="get" class="row row-cols-lg-auto align-items-center">
                                            <div class="col-12 col-lg-4">
                                                ...
                                                <?php
                                                    ...
                                                    { 
                                                    ?>
                                                    <option value ="<?php echo $cffrt['member_id']; ?>" <?php if($icd === $cffrt['member_id']){echo "selected";} ?>><?php echo $cffrt['fname']." ".$cffrt['lname'];?> ( <?php echo $cffrt['userid'];?> ) </option>
                                                <?php } ?>
                                                </select>
                                            </div>
                                    ...
                                    <table class="table table-centered datatable dt-responsive nowrap table-card-list" style="border-collapse: collapse; border-spacing: 0 12px; width: 100%;">
                                        ...
                                        <?php
                                            $i = 1;
                                            if($icd != '0'){
                                                $brnadSQL="select t1.* from child_counter_6 t1  WHERE `uid` LIKE '$icd%'"; 
                                                $ResultSQL=mysqli_query($link,$brnadSQL); 
                                                while($Listbrand=mysqli_fetch_array($ResultSQL)) {
                                                    $tr=mysqli_fetch_assoc(mysqli_query($db,"SELECT * FROM `membership` WHERE `member_id`='$icd' "));
                                            ?>
                                        <tr>

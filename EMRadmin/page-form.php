  ...
  <div class="main-content">
    <div class="page-content">
      <div class="container-fluid"> 
        ...
        <form action="page-manage.php" name="cont" class="dropzone" id="myform"  method="post" enctype="multipart/form-data">
          <div class="row">
            <div class="col-lg-12">
                  ...
                  <div id="addproduct-billinginfo-collapse" class="collapse show" data-bs-parent="#addproduct-accordion">
                    <div class="p-4 border-top">
                      ...
                      <div class="row">
                        <div class="col-lg-4">
                          <div class="mb-3">
                            <label class="form-label" for="manufacturerbrand">Select Child Page</label>
	...
	?>
                        ...
                        <div class="col-md-4">
                          <div class="mb-3">
                            ...
                            <input id="sortorder" name="page_name" type="text" class="form-control" value="<?php echo $row_cms['page_name'];?>">
                          </div>
                        </div>
                        <div class="col-md-4">
                          <div class="mb-3">
                            <label class="form-label" for="price">Page Links</label>
                            <input id="sortorder" name="seo_keyword" type="text" class="form-control" value="<?php echo $row_cms['seo_keyword'];?>">
                          </div>
                        </div>
                      </div>
                      <div class="row">
                        ...
                        <div class="col-md-4">
                          <div class="mb-3">
                            <label class="form-label" for="price">Meta Titles</label>
                            <input id="linname" name="meta_title" type="text" class="form-control" value="<?php echo $row_cms['meta_title'];?>">
                          </div>
                        </div>
                        <div class="col-md-4">
                          <div class="mb-3">
                            <label class="form-label" for="price">Meta Keywords</label>
                            <input id="linkgo" name="meta_keywords" type="text" class="form-control" value="<?php echo $row_cms['meta_keywords'];?>">
                          </div>
                        </div>
                        <div class="mb-4 row">
                                            <label class="form-label" for="price">Meta Description</label>
							<textarea name="meta_description" class="form-control"><?php echo $row_cms['meta_description']; ?></textarea>
                                            </div>
                                        </div>
                        <div class="box-fileupload col-md-3">
                          <input type="file" id="fileId" class="file-upload-input" name="image">
                          ...
                          <img src="../uploads/page/<?php echo $row_cms['image'];?>" width="<?php echo $width; ?>100" height="<?php echo $height; ?>" class="alignLeft" />
                          <?php } ?>
                        </div>
                      </div>

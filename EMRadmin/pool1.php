...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Pool 1 Team | EMR Marketing</title>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0">Pool 1 Team </h4>

                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="javascript: void(0);">CMS</a></li>
                                            <li class="breadcrumb-item active">Pool 1 Team </li>
                                        </ol>
                                    </div>
                                ...
                                <div class="table-responsive mb-4">
                                        ...
                                        <form name="LevelFilter" action="" method="get" class="row row-cols-lg-auto align-items-center">
                                            ...
                                            <div class="col-12 col-lg-4">
                                                ...
                                                <?php
                                                    $id = 1;
                                                    $sql=mysqli_query($db,"SELECT t1.*,t1.id as idd
                                                    FROM `child_counter_10` t1 where t1.uid LIKE '$bif%' ");
                                                    while($row = mysqli_fetch_assoc($sql))
                                                    { 
                                    ...
                                    <table class="table table-centered datatable dt-responsive nowrap table-card-list" style="border-collapse: collapse; border-spacing: 0 12px; width: 100%;">
                                        ...
                                        <tr>
                                            ...
                                            <td><?php if($ci == 1){echo $amt = "4";}elseif($ci == 2){echo $amt = "8";}elseif($ci == 3){echo $amt = "16";}elseif($ci == 4){echo $amt = "16";}elseif($ci == 5){echo $amt = "32";}elseif($ci == 6){echo $amt = "128";}?> </td>

...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Pool Activation History | EMR Marketing</title>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0">Pool Activation History </h4>

                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="javascript: void(0);">CMS</a></li>
                                            <li class="breadcrumb-item active">Pool Activation History </li>
                                        </ol>
                                    </div>
                                                        ...
                                                        <div class="col-lg-12">
                                                                ...
                                                                <div class="table-responsive mb-4">
                                                                    <table class="table table-centered datatable dt-responsive nowrap table-card-list" style="border-collapse: collapse; border-spacing: 0 12px; width: 100%;">
                                                                        ...
                                                                        <?php
                                                                        $i = 1;
                                                                        $brnadSQL="select t1.*,t1.date as dt from `pool_activation` t1 order by t1.date DESC"; 
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td><?php if($Listbrand['pool'] == 1){echo "Pool 2";}elseif($Listbrand['pool'] == 2){echo "Booster 1";}elseif($Listbrand['pool'] == 3){echo "Booster 2";}elseif($Listbrand['pool'] == 4){echo "Booster 3";}elseif($Listbrand['pool'] == 8){echo "Pool 2 Re-Entry (Level 6)";}elseif($Listbrand['pool'] == 8){echo "Pool 2 Re-Entry (Level 6)";}elseif($Listbrand['pool'] == 9){echo "Pool 2 Re-Entry (Level 7)";}elseif($Listbrand['pool'] == 10){echo "Pool 2 Re-Entry (Level 8)";}elseif($Listbrand['pool'] == 11){echo "Pool 2 Re-Entry (Level 9)";}elseif($Listbrand['pool'] == 12){echo "Pool 2 Re-Entry (Level 10)";}elseif($Listbrand['pool'] == 13){echo "Pool 2 Re-Entry (Level 11)";}?> </td>
                                                                            
                                                                            <td><?php echo $Listbrand['dt'];?></td>

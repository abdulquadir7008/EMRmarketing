...
$sql1 = "SELECT t1.left_ccount,t1.self_buss,t1.right_ccount,t1.uid,t1.left_paid_count,t1.right_paid_count,t1.total_left_paid_bvcount,t1.total_right_paid_bvcount FROM `child_counter` t1 join membership t4 on t1.uid=t4.member_id  where total_left_paid_bvcount>0 and total_right_paid_bvcount>0  and t1.uid = '88'";

...
// $password=md5($_REQUEST['password']);
  $queryatleast="insert into up_trans_history1(uid,amount,txn_sc,txn_id,date,status,wal_type) values('$uid','$amount','$image0','$txn_id',now(),'0','7')";
...
echo "<script type='text/javascript'>window.location.href = 'gold.php';</script>";
session_write_close();
}
?>
<?php
			...
			<main class="page-main">
				<div class="block">
					<div class="container">
						<ul class="breadcrumbs">
							...
							<li>/<span>Gold Booster Wallet</span></li>
						</ul>
					</div>
				</div>
				<div class="container">
                ...
                <div class="dashboard-detail addres-book">
                  ...
                  <div class="inform_h4">
                    ...
                    <form class="theme-form" action="gold.php" method="post" enctype="multipart/form-data">
                      <div class="row form-row">
                        <div class="col-md-6">
                          <label class="field-label">Amount *</label>
                          <input type="number" min="500" name="amount"  class="form-control" placeholder="Amount" required>
                        </div>
                        <div class="col-md-6">
                                    ...
                                    <div class="card dashboard-table mt-0">
                                        <div class="card-body table-responsive-sm" style="padding:0;">
                                            ...
                                            ?>
                                             <?php
                                                $i = 1;
                                                 $brnadSQL="select t1.*,t1.status as st,t1.date as sdat,t2.* from up_trans_history1 t1 join membership t2 on t2.member_id = t1.uid where  t1.amount > 0 and t1.wal_type = '7' and  t1.uid='$customeid' order by t1.id DESC"; 
                                                $ResultSQL=mysqli_query($link,$brnadSQL); 

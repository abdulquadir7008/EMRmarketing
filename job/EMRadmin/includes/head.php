...
?>
<header class="header"> <a href="index.php" class="logo"> Tangible
        ...
        <li class="dropdown messages-menu"> <a href="#" class="dropdown-toggle" data-toggle="dropdown"> <i class="fa fa-envelope"></i> <span class="label label-success"><?php echo mysqli_num_rows($result_cms45);?></span> </a>
          <ul class="dropdown-menu">
            ...
            <li>
              <ul class="menu">
                <?php
                while ( $row_cms78589 = mysqli_fetch_array( $result_cms451 ) ) {
                  ?>
                <li> <a href="mailbox_details.php?id=<?php echo $row_cms78589['id'];?>&&<?php echo $row_cms78589['session'];?>">
                  <h4> <?php echo $row_cms78589['fromer']; ?> <br />
                    <small><i class="fa fa-clock-o"></i> <?php echo $row_cms78589['date']; ?> </small> </h4>

...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>KYC Request | EMR Marketing</title>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0">KYC Request </h4>

                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="javascript: void(0);">CMS</a></li>
                                            <li class="breadcrumb-item active">KYC Request </li>
                                        </ol>
                                    </div>
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="table-responsive mb-4">
                                    <table class="table table-centered datatable dt-responsive nowrap table-card-list" style="border-collapse: collapse; border-spacing: 0 12px; width: 100%;">
                                        ...
                                        <?php
                                        $i = 1;
                                        $brnadSQL="select t1.*,t1.status as st,t1.date as sdat,t2.* from up_trans_history11 t1 join membership t2 on t2.member_id = t1.uid where t1.status = 0 order by t1.id DESC"; 
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php 
                                                    if($Listbrand['st']=='0'){ ?>
                                                        <span class="badge btn btn-primary badge-success ApproveRejTopup1" data-id="<?php echo $Listbrand['id'];?>" data-status="1">Approve</span>
                                                        <span class="badge btn btn-primary badge-danger ApproveRejTopup1" data-id="<?php echo $Listbrand['id'];?>" data-status="2">Reject</span>
                                                    <?php }
                                                    else{echo "Approved";}
                                                ?>
                                            </td>
                                            ...
                                            <td><a target="_blank" href="../uploads/<?php echo $Listbrand['image'];?>"> <img src="../uploads/<?php echo $Listbrand['image'];?>" width="100" height="100" class="alignLeft" /> </a></td>
                                            <td><a target="_blank" href="../uploads/<?php echo $Listbrand['image1'];?>"> <img src="../uploads/<?php echo $Listbrand['image1'];?>" width="100" height="100" class="alignLeft" /> </a></td>
                                            <td><a target="_blank" href="../uploads/<?php echo $Listbrand['image2'];?>"> <img src="../uploads/<?php echo $Listbrand['image2'];?>" width="100" height="100" class="alignLeft" /> </a></td>
                                            <td><a target="_blank" href="../uploads/<?php echo $Listbrand['image3'];?>"> <img src="../uploads/<?php echo $Listbrand['image3'];?>" width="100" height="100" class="alignLeft" /> </a></td>
...
<?php include('includes/footer.php')?>
        ...
        <script src="../bootbox.js" integrity="sha512-RdSPYh1WA6BF0RhpisYJVYkOyTzK4HwofJ3Q7ivt/jkpW6Vc8AurL1R+4AUcvn9IwEKAPm/fk7qFZW3OuiUDeg==" crossorigin="anonymous" referrerpolicy="no-referrer"></script>
        <script>
            $("body").on('click', '.ApproveRejTopup1', function()
            {
                $elm=$(this);
                bootbox.confirm({

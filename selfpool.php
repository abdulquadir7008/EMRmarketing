                                                        ...
                                                        <div class="card-body table-responsive-sm" style="padding:0;">
                                                            ...
                                                            <?php
                                                                ...
                                                                for ($i=1; $i < 12; $i++) { 
                                                                    ...
                                                                    $row1 = mysqli_fetch_assoc($sql);
                                                                    $res=GetUsersIDPool($db,$i,$icd,'pairing_1'); 
                                                                    $count = count($res); 
                                                                    $decimalNumber = $icd;
                                                                ...
                                                                ?>
                                                                    <tr>
                                                                        ...
                                                                        <td><?php if($i == 1){echo $amt = "50";}elseif($i == 2){echo $amt = "100";}elseif($i == 3){echo $amt = "200";}elseif($i == 4){echo $amt = "400";}elseif($i == 5){echo $amt = "800";}elseif($i == 6){echo $amt = "525";}elseif($i == 7){echo $amt = "375";}elseif($i == 8){echo $amt = "750";}elseif($i == 9){echo $amt = "1500";}elseif($i == 10){echo $amt = "2325";}elseif($i == 11){echo $amt = "3675";}?> </td>

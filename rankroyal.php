				...
				<div class="block">
					<div class="container">
						<ul class="breadcrumbs">
							...
							<li>/<span>Rank Club Royalty Income</span></li>
						</ul>
					</div>
				</div>
				<div class="container">
						...
						<div class="col-md-9 aside">
							...
							<div class="page-title">
								<div class="title center">
									<h1>Rank Club Royalty Income</h1>
								</div>
							</div>
							<!-- /Page Title -->
							<!-- Categories Info -->
                                    ...
                                    <div class="card dashboard-table mt-0">
                                        <div class="card-body table-responsive-sm" style="padding:0;">
											...
											?>
                                             <?php
                                                $i = 1;
                                                 $brnadSQL="select t1.*,t1.date as dr,t2.* from `royalty_income` t1 join membership t2 on t2.member_id = t1.uid where  t1.amount > 0 and  t1.uid='$customeid' order by t1.id DESC"; 

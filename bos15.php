				...
				<div class="block">
					<div class="container">
						<ul class="breadcrumbs">
							...
							<li>/<span>Booster 1 (B5) Team</span></li>
						</ul>
					</div>
				</div>
				<div class="container">
						...
						<div class="col-md-9 aside">
							...
							<div class="info-block">
								<div class="dashboard-detail addres-book">
                                    <h4>Booster 1 (B5) Team History</h4>
                                                    ...
                                                    <div class="row form-row">
                                                        <div class="col-12 col-lg-9">
                                                            ...
                                                            <?php
                                                                ...
                                                                FROM `child_counter_8` t1 where t1.uid LIKE '$customeid%' ");
                                                    ...
                                                    <div class="card dashboard-table mt-0">
                                                        <div class="card-body table-responsive-sm" style="padding:0;">
                                                            ...
                                                            <?php
                                                                ...
                                                                if($icd != '0'){
                                                                    $brnadSQL="select t1.* from child_counter_8 t1 where t1.uid = '$icd'"; 

          ...
          <div class="form-card">
            ...
            <form class="theme-form" action="emrscript/regsiterpros.php" method="post" enctype="multipart/form-data">
              <div class="sopnser_input_details">
                ...
                <input type="radio" name="sponser_status" value="yes" onclick="show2();" required />
                Sponser ID
				   <input type="radio" name="sponser_status" value="no" onclick="show1();" required />
                None
                <div id="div1rup" class="hiderup">
					
					<div class="sponser_dil">
                  
                  <input type="text" id="sponsor_id" name="spnoser_id" maxlength="30" class="form-control" placeholder="Sponser ID *" required>
                </div>
                   </div>
              </div>

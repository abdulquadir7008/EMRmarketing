                                    ...
                                    <div class="card dashboard-table mt-0">
                                        <div class="card-body table-responsive-sm" style="padding:0;">
											...
											?>
                                             <?php
                                                $i = 1;
                                                 $brnadSQL="select t1.*,t1.date as drs,t1.status as stt,t2.* from up_trans_history111 t1 join membership t2 on t2.member_id = t1.uid where  t1.amount > 0 and  t1.uid='$customeid' order by t1.id DESC"; 
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <span class="  badge badge-success" disabled>Approved</span>
                                                            <?php } else if(isset($Listbrand['stt']) && $Listbrand['stt']==2) { ?>
                                                            <span class="  badge badge-danger" disabled>Rejected</span>
                                                            <?php } else if(isset($Listbrand['stt']) && $Listbrand['stt']==0) { ?>
                                                            <span class="  badge badge-success" disabled>Pending</span>
                                                            <?php } ?>
                                                        </td>
                                                    </tr>
                                                    <?php } ?>

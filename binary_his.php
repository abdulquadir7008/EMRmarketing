                                    ...
                                    <div class="card dashboard-table mt-0">
                                        <div class="card-body table-responsive-sm" style="padding:0;">
											...
											?>
                                             <?php
                                                $i = 1;
                                                 $brnadSQL="select t1.*,t1.date as st,t2.* from binary_income t1 join membership t2 on t2.member_id = t1.uid where  t1.amount > 0 and  t1.uid='$customeid' order by t1.id DESC"; 
